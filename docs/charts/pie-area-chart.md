...
To create a new Pie Chart, click the `Make your Chart` button on the [LiveGap Charts Home screen](https://charts.livegap.com/) and select `Pie Chart` from the list of options.
